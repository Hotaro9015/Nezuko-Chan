    ...
    client.distube
      ...
      .on("searchCancel", message => message.channel.send({
        embeds: [
          ...
          .setFooter(ee.footertext, ee.footericon)
          .setTimestamp()
          .setTitle(`<:no_entry:995294184061816832> Searching Canceled`)
        ]
      }))
      .on("error", (channel, e) => {
        console.error(e);
        channel.send({
          embeds: [
            ...
            .setFooter(ee.footertext, ee.footericon)
            .setTimestamp()
            .setTitle(`<:no:995153594032599112>️ Error`)
            .setDescription(`${e}`)
          ]
        })
      })
      .on("empty", queue => queue.textChannel.send({
        embeds: [
          ...
          .setFooter(ee.footertext, ee.footericon)
          .setTimestamp()
          .setTitle(`<a:Leave:995295509960986686>️ Leaving Channel`)
      ...
      .on("finish", queue => queue.textChannel.send({
        embeds: [
          ...
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setTitle("<:no_entry:995294184061816832>️ SONG FINISHED, LEAVING...")
          .setDescription("<a:earphones_pink:995293781433786418> **There are no more songs in the queue leaving...**")
          .setTimestamp()
        ]
      }))
