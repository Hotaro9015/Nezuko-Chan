    ...
    client.on("guildMemberRemove", async (member) => {
      ...
      try {
        ...
        Schema2.findOne({
          ...
          await channel.send({ content: `Look like **${member.user.tag}** just left the server <a:crying:995297218045169695>`, files: [attachment] }).catch(err => console.log('I was unable to send goodbye image.'));
