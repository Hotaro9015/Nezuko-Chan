    ...
    try {
      switch (options.getSubcommand()) {
        case "set": {
          ...
          Embed.setColor("#FFD700").setDescription(`>>> You have Been Set to AFK <a:Muted:995267040938037248>
**Status:** ${afkStatus}`);
        ...
        case "remove": {
          ...
          Embed.setColor("#FFD700").setDescription(`>>> You have Been Removed From AFK <a:Muted:995267040938037248>`);
