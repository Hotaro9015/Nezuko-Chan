            ...
            switch (interaction.options.getSubcommand()) {
                case "set": {
                    ...
                    if (member.roles.highest.position >= interaction.member.roles.highest.position) return interaction.reply({
                        embeds: [new MessageEmbed()
                            .setColor("#FFD700")
                            .setFooter("Thanks For Using Me", `https://cdn.discordapp.com/emojis/995237112486051890.png`)
                ...
                case "remove": {
                    ...
                    if (member2.roles.highest.position >= interaction.member.roles.highest.position) return interaction.reply({
                        embeds: [new MessageEmbed()
                            .setColor("#FFD700")
                            .setFooter("#FFD700".footertext, `https://cdn.discordapp.com/emojis/995237112486051890.png`)
